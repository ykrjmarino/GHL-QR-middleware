...
const { dbTesting, verifyTicket, dbNameTesting, generateTicket, createOrder, paymentRecord, batchGenerateTicket, batchGenerateTicketv2 } = require('./ticketController');
...
app.post('/ticket/batch-generate', batchGenerateTicketv2);  //several ticket generation with separators in ticket id and URL to identify different tickets in the same order/batch
